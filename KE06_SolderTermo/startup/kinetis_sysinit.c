...
void MSCAN_Rx_IRQHandler() __attribute__ ((weak, alias("Default_Handler")));
void MSCAN_Tx_IRQHandler() __attribute__ ((weak, alias("Default_Handler")));
...
void (* const InterruptVector[])() __attribute__ ((section(".vectortable"))) = {
    ...
    I2C1_IRQHandler,		/* Single interrupt vector for all sources */
	...
	MSCAN_Rx_IRQHandler,	/* MSCAN Rx Interrupt */
	MSCAN_Tx_IRQHandler,	/* MSCAN Tx, Err and Wake-up interrupt */
};
#endif
