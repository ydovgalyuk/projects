...
#define USB_STR_1_SIZE  (2*28) /* bus reported vendor string */
#define USB_STR_2_SIZE  (2*16) /* bus reported device description string */
#define USB_STR_3_SIZE  (2*9) /* serial number descriptor string */
