...
/*
** ===================================================================
**     Event       :  RF24_OnInterrupt (module Events)
**
**     Component   :  RF24 [nRF24L01]
**     Description :
...
void RFIDirq_OnInterrupt(void);
/*
** ===================================================================
**     Event       :  RFIDirq_OnInterrupt (module Events)
**
**     Component   :  RFIDirq [ExtInt]
**     Description :
**         This event is called when an active signal edge/level has
**         occurred.
**     Parameters  : None
